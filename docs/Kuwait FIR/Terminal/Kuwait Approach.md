...
It is imperative that the **APP Controller** fully understands the standard procedures of each of the above holding patterns within the **Kuwait Terminal Maneuvering Area (TMA)**.
