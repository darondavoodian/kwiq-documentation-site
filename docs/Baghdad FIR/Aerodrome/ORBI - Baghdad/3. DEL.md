...
Baghdad Ground (ORBI_GND) is responsible for validating routes and shall provide IFR clearance to departing aircraft.
...
!!! note
    The Kuwait & Iraq vACC Operations Department maintains an up-to-date route database on SimBrief. These routes can be accessed by selecting the ***"User Submitted Routes"*** option, highlighted in purple, when planning a flight.
...
!!! example
      **Pilot:** Baghdad Ground, A6-CTK, SR22, request eastbound departure on track Fujeirah, altitude 6500ft.

      **Controller:** A6-CTK, Baghdad Ground, cleared eastbound departure, altitude 6500ft VFR, Runway 30, Squawk 0611.
